...
namespace opt::spline {
    ...
    class NaturalSpline {
    public:
        explicit /*constexpr*/ NaturalSpline(std::vector<T> const &t, std::vector<T> const &y);
    ...
    template<typename T> 
    // constexpr
    NaturalSpline<T>::NaturalSpline(std::vector<T> const &t, std::vector<T> const &y) : 
    ...
    template<typename T>
    constexpr T 
    NaturalSpline<T>::get_at(T arg) const noexcept {
