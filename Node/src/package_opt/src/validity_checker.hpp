...
namespace opt
{
    ...
    public:
        ...
        explicit ValidityChecker(const ompl::base::SpaceInformationPtr &space_information, package_opt::Cones::ConstPtr const &cones) : ompl::base::StateValidityChecker(space_information), obstacles(cones)
        {
            static_assert(std::is_floating_point_v<T>);
